...
PLAYBOOK_PATH = Path(__file__).parent / "soc_playbooks.json"
CHROMA_DIR    = Path(__file__).parent.parent.parent / "data" / "chroma_db"  # Where ChromaDB stores its vectors locally
